...
export type StringTest04 = Expect<Equals<Tokenize<'Hello {name}'>, [StringInterpolationToken<'name'>]>>;
export type StringTest05 = Expect<Equals<Tokenize<"Hello '{name}">, []>>;
export type StringTest06 = Expect<Equals<Tokenize<"Hello '{name}'">, []>>;
export type StringTest07 = Expect<Equals<Tokenize<'Hello {firstname} {lastname}'>, [
    StringInterpolationToken<'firstname'>,
    StringInterpolationToken<'lastname'>
]>>;
export type StringTest08 = Expect<Equals<Tokenize<"Hello '{firstname} {lastname}">, [StringInterpolationToken<'lastname'>]>>;
