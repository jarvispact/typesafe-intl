...
type _Tokenize<Tokens extends Token[], State extends States[keyof States], NameBuffer extends string[], TypeBuffer extends string[], FormatBuffer extends string[], OptionsBuffer extends string[], CurlyBracketCounter extends number, Translation extends string> = Translation extends `${infer Head}${infer Tail}` ? State extends States['Start'] ? Head extends '{' ? _Tokenize<Tokens, States['InterpolationStart'], NameBuffer, TypeBuffer, FormatBuffer, OptionsBuffer, CurlyBracketCounter, Tail> : Head extends "'" ? Tail extends `{${infer TailTail}` ? _Tokenize<Tokens, States['Escaped'], NameBuffer, TypeBuffer, FormatBuffer, OptionsBuffer, CurlyBracketCounter, TailTail> : _Tokenize<Tokens, State, NameBuffer, TypeBuffer, FormatBuffer, OptionsBuffer, CurlyBracketCounter, Tail> : Head extends '<' ? _Tokenize<Tokens, States['RichText'], NameBuffer, TypeBuffer, FormatBuffer, OptionsBuffer, CurlyBracketCounter, Tail> : _Tokenize<Tokens, State, NameBuffer, TypeBuffer, FormatBuffer, OptionsBuffer, CurlyBracketCounter, Tail> : State extends States['InterpolationStart'] ? Head extends ',' ? _Tokenize<Tokens, States['InterpolationType'], NameBuffer, TypeBuffer, FormatBuffer, OptionsBuffer, CurlyBracketCounter, Tail> : Head extends '}' ? _Tokenize<[
    ...Tokens,
    ...
    ...OptionsBuffer,
    Head
], CurlyBracketCounter, Tail> : State extends States['Escaped'] ? Tail extends `${string}}'${infer TailTail}` ? _Tokenize<Tokens, States['Start'], NameBuffer, TypeBuffer, FormatBuffer, OptionsBuffer, CurlyBracketCounter, TailTail> : Tail extends `${string}}${infer TailTail}` ? _Tokenize<Tokens, States['Start'], NameBuffer, TypeBuffer, FormatBuffer, OptionsBuffer, CurlyBracketCounter, TailTail> : 'no idea what to do here' : State extends States['RichText'] ? Head extends '>' ? Tail extends `${infer Children}</${Trim<Join<NameBuffer>>}>${infer TailTail}` ? _Tokenize<[
    ...Tokens,
